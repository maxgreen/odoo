...
// clarified and separated.
    ...
    var Session = core.Class.extend(mixins.EventDispatcherMixin, {
        ...
        init: function (parent, origin, options) {
            console.debug("session.js init ",parent,origin,options);
        ...
        session_authenticate: function () {
            console.debug("session_authenticate");
            var self = this;
        ...
        _session_authenticate: function (db, login, password) {
            console.debug("_session_authenticate");
            var self = this;
        ...
        on_modules_loaded: function () {
            console.debug("on_modules_loaded");
        ...
        session_reload: function () {
            console.debug("session_reload", window.odoo.session_info);
