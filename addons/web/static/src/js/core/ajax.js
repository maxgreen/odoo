odoo.define('web.ajax', function (require) {
    ...
    function jsonpRpc(url, fct_name, params, settings) {
        console.debug("ajax.js jsonpRpc\nurl=", url, "\nfct_name=",fct_name,"\nparams=",params, "\nsettings=",settings);
        settings = settings || {};
        return genericJsonRpc(fct_name, params, settings, function (data) {
...
// helper
    ...
    var loadJS = (function () {
        ...
        var load = function loadJS(url) {
            console.debug("ajax.js loadJS",url);
    ...
    function get_file(options) {
        console.debug("ajax.js get_file", options);
    ...
    function post(controller_url, data) {
        console.debug("ajax.js post", options);
    ...
    function loadLibs(libs) {
        console.debug("ajax.js loadLibs", libs);
        var defs = [];
